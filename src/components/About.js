...
export default function About(){
	return (
		<>
			<section className='bg-blackMain w-full min-h-[50vh] flex items-center flex-col'>

				<div className='flex justify-center items-center flex-col'> 
					<h2 className='text-blueMain text-justify w-[4.5rem]'>&lt;About&gt;</h2>

					<div className='flex items-center max-w-[35rem] text-center flex-col text-justify'>
